...
export default function MermaidEditor() {
  ...
  const renderDiagram = React.useCallback(async (mermaidCode: string) => {
    ...
    <div className="mermaid-editor">
      ...
      <div className="row mb-2">
        ...
        <div className="col-sm-6 text-end">
          <a
            href={imageUrl || "#"}
            className={`btn btn-primary btn-sm ${!imageUrl || error ? "disabled" : ""}`}
      ...
      <div className="row">
        <div className="col-sm-12">
          <div style={PREVIEW_STYLE}>
            {!code && <div className="text-muted p-4">Please enter Mermaid code</div>}
